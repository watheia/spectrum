...
The best place to ask questions and get help with React Spectrum is on Github. Please [file an issue](https://gitlab.com/watheia/spectrum/issues)
...
features. Please check the [existing issues on GitHub](https://gitlab.com/watheia/spectrum/issues) before filing a new bug
...
[project boards](https://gitlab.com/watheia/spectrum/projects) on Github for details about our high level goals for each
