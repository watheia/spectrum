...
description: This is the last post in our three part series on building a button component. In the [first post](https://watheia.app/blog/building-a-button-part-1.html), we covered how React Spectrum and React Aria implement adaptive press events across mouse, touch, keyboard, and screen readers. In the [second post](https://watheia.app/blog/building-a-button-part-2.html), we covered hover interactions. Today, we’ll cover keyboard focus behavior.
date: 2020-09-09
...
This is the last post in our three part series on building a button component. In the [first post](https://watheia.app/blog/building-a-button-part-1.html), we covered how React Spectrum and React Aria implement adaptive press events across mouse, touch, keyboard, and screen readers. In the [second post](https://watheia.app/blog/building-a-button-part-2.html), we covered hover interactions. Today, we’ll cover keyboard focus behavior.
...
This focus normalization behavior is implemented by the [usePress](https://watheia.app/react-aria/usePress.html) hook in React Aria, which is used by [useButton](https://watheia.app/react-aria/useButton.html), [useCheckbox](https://watheia.app/react-aria/useCheckbox.html), [useRadio](https://watheia.app/react-aria/useRadioGroup.html), and many other hooks. If you’re implementing your own components, I’d highly recommend checking them out to ensure the focus behavior is consistent across browsers.
