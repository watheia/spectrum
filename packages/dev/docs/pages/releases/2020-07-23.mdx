...
- Replace `:hover` CSS pseudo class with [useHover](../../react-aria/useHover.html) hook across all components for improved touch/hybrid device support - [@so99ynoodles](https://github.com/so99ynoodles) - [PR](https://gitlab.com/watheia/spectrum/pull/775)
- Allow no props to be given to [useToggleState](../../react-stately/useToggleState.html) - [@Andarist](https://github.com/Andarist) - [PR](https://gitlab.com/watheia/spectrum/pull/687)
- Allow arbitrary number of prop objects to be passed to mergeProps - [@brookslybrand](https://github.com/brookslybrand) - [PR](https://gitlab.com/watheia/spectrum/pull/776)
- Add [useSingleSelectListState](../../react-stately/useSingleSelectListState.html) hook to `@react-stately/list` - [@devongovett](https://github.com/devongovett) - [PR](https://gitlab.com/watheia/spectrum/pull/802)
- Add active state to textfield for mobile - [@devongovett](https://github.com/devongovett) - [PR](https://gitlab.com/watheia/spectrum/pull/823)

## Fixed

- Add check for SSR environment to [useFocusVisible](../../react-aria/useFocusVisible.html) - [@RafalFilipek](https://github.com/RafalFilipek) - [PR](https://gitlab.com/watheia/spectrum/pull/769)
- Ignore selected keys when `selectionMode="none"` in menu - [@jluyau](https://github.com/jluyau) - [PR](https://gitlab.com/watheia/spectrum/pull/783)
- Fix tabbing to a disabled Picker in HiddenInput - [@gavinhenderson](https://github.com/gavinhenderson) - [PR](https://gitlab.com/watheia/spectrum/pull/787)
- Fix typescript build errors/warnings - [@mischnic](https://github.com/mischnic) - [PR](https://gitlab.com/watheia/spectrum/pull/713)
- Update lint rules - [@snowystinger](https://github.com/snowystinger) - [PR](https://gitlab.com/watheia/spectrum/pull/747)
- Workaround for iOS hover events bug - [@devongovett](https://github.com/devongovett) - [PR](https://gitlab.com/watheia/spectrum/pull/815)
- Fix hover and active styles for Radio invalid state - [@devongovett](https://github.com/devongovett) - [PR](https://gitlab.com/watheia/spectrum/pull/819)
- Fix hover transition for icons in Safari - [@snowystinger](https://github.com/snowystinger) - [PR](https://gitlab.com/watheia/spectrum/pull/821)
- Ensure react is a peer dependency instead of a dependency - [@devongovett](https://github.com/devongovett) - [PR](https://gitlab.com/watheia/spectrum/pull/824)

## Docs

- Fix `useKeyboard` example - [@spbyrne](https://github.com/spbyrne) - [PR](https://gitlab.com/watheia/spectrum/pull/759)
- Fix package imports for React Aria/React Stately packages - [@DeMoorJasper](https://github.com/DeMoorJasper) - [PR](https://gitlab.com/watheia/spectrum/pull/761)
- JSDocs eslint - [@snowystinger](https://github.com/snowystinger) - [PR](https://gitlab.com/watheia/spectrum/pull/662)
- fix: some typos of react-aria - [@grgr-dkrk](https://github.com/grgr-dkrk) - [PR](https://gitlab.com/watheia/spectrum/pull/774)
- Fix individual import in versioning docs - [@mischnic](https://github.com/mischnic) - [PR](https://gitlab.com/watheia/spectrum/pull/792)
- Fix typo in ListBox docs - [@evargast](https://github.com/evargast) - [PR](https://gitlab.com/watheia/spectrum/pull/795)
