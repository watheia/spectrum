...
.coca-cola-theme {
  ...
  --spectrum-global-color-gray-100: rgb(255, 255, 255);definitionsforallspectrumglobalthemevariables--spectrum-global-color-gray-100
  ...
  --spectrum-button-background-color: red;definitionsforindividualcomponentoverrides--spectrum-button-background-color
}
```
