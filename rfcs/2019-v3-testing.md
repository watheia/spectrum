...
1. [Architecture changes powered by React Hooks](https://github.com/watheia/spectrum/blob/main/rfcs/2019-v3-architecture.md)
...
Sample implementation can be found here: https://github.com/watheia/spectrum/compare/v3...test_framework_explore. Feedback is greatly appreciated.
