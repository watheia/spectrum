...
let theme = getVars(`${__dirname}/../packages/@watheia/spectrum-css-temp/vars/spectrum-light.css`);
let scale = getVars(`${__dirname}/../packages/@watheia/spectrum-css-temp/vars/spectrum-medium.css`);
