...
function getVariableMappings(themes) {
  ...
  for (let theme of themes) {
    let values = getVars(
      `${__dirname}/../packages/@watheia/spectrum-css-temp/vars/spectrum-${theme}.css`
    );
...
let themes = getVariableMappings([
  "dark",
  "darkest",
  "light",
  "lightest",
...
let globals = getVars(
  `${__dirname}/../packages/@watheia/spectrum-css-temp/vars/spectrum-global.css`
);
