...
The current v2 Card implementation does not completely conform to this spec: see (PR #691)[https://gitlab.com/watheia/spectrum/pull/691] for a more complete implementation.
