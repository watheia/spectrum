...
The current v2 Card implementation does not completely conform to this spec: see (PR #691)[https://github.com/watheia/rsp-kit/pull/691] for a more complete implementation.
