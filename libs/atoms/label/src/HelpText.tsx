...
import { classNames, useDOMRef } from "@waweb/utils"
import { DOMRef, SpectrumHelpTextProps } from "@react-types/shared"
import React, { HTMLAttributes } from "react"
import styles from "libs/styles/src/helptext/vars.module.css"
    ...
    >
      {isErrorMessage ? (
        <>
          ...
          <div
            {...errorMessageProps}
            className={classNames(styles, "spectrum-HelpText-text")}
          >
            {errorMessage}
          </div>
        </>
