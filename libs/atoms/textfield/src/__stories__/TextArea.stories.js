...
import { Button } from "@waweb/button"
import { Flex } from "@waweb/atoms.layout"
import { Form } from "@waweb/form"
...
storiesOf("TextArea", module)
  ...
  .add("isQuiet, value", () => render({ isQuiet: true, value: "foo  ".repeat(10) }))
  ...
  .add("icon: Info, isDisabled", () => render({ icon: <Info />, isDisabled: true }))
  ...
  .add("no visible label", () => render({ label: null, "aria-label": "Street address" }))
  .add("with description", () => render({ description: "Enter product feedback." }))
