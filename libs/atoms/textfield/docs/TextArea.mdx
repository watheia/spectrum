...
import { Layout } from "@waweb/mdx"
export default Layout

import docs from "docs:@waweb/atoms.textfield"
import { HeaderInfo, PropTable } from "@waweb/mdx"
import packageData from "@waweb/atoms.textfield/package.json"

```jsx import
import { TextArea } from "@waweb/atoms.textfield"
...
<HeaderInfo packageData={packageData} componentNames={["TextArea"]} sourceData={[]} />
...
function Example() {
  ...
  return (
    <Flex direction="column">
      <TextArea placeholder="Enter some text" onChange={setText} label="Your text" />
...
function Example() {
  ...
  return (
    <TextArea
      ...
      errorMessage={
        value === "" ? "Empty input not allowed." : "Single digit numbers are 0-9."
      }
    />
  )
}
