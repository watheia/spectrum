...
import { CSSModule } from "@waweb/model"
...
export function SlotProvider(props: { slots?: {} | undefined; children: any }) {
...
export function ClearSlots(props: { [x: string]: any; children: any }) {
  ...
  return (
    // @ts-ignore
    <SlotContext.Provider value={{}}>{content}</SlotContext.Provider>
  )
}
