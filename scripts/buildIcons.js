...
const PACKAGES = {
  ui: path.dirname(require.resolve('@watheia/react-spectrum-ui/dist/')),
  workflow: path.dirname(
    require.resolve('@watheia/react-spectrum-workflow/dist/')
  ),
  color: path.dirname(
    require.resolve('@watheia/react-spectrum-workflow-color/dist/')
  ),
